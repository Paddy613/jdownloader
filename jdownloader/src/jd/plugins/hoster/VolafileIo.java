...
@HostPlugin(revision = "$Revision: 36356 $", interfaceVersion = 2, names = { "volafile.io" }, urls = { "https?://(?:www\\.)?volafile\\.io/(?:get|download)/[A-Za-z0-9\\-_]+/[^/]+|https?://dl\\d+\\.volafile\\.io/(?:redir/)?get/[A-Za-z0-9\\-_]+/[^/]+" })
