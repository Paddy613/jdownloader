...
@HostPlugin(revision = "$Revision: 34706 $", interfaceVersion = 3, names = { "movyo.to", "letwatch.us" }, urls = { "https?://(?:www\\.)?(?:movyo\\.to)/(embed\\-|video/)[a-z0-9]{12}", "https?://(www\\.)?(?:letwatch\\.us(?:\\.com)?|letwatch\\.to)/(embed\\-)?[a-z0-9]{12}" }) 
