...
@HostPlugin(revision = "$Revision: 36193 $", interfaceVersion = 2, names = { "filez.tv" }, urls = { "https?://(?:www\\.)?filez\\.tv/[A-Za-z0-9]+" })
public class FilezTv extends PluginForHost {

    public FilezTv(PluginWrapper wrapper) {
        super(wrapper);
     ...
     * YetiShareBasic Version 0.9.1-psp<br />
     * mods:<br />
     * limit-info: 2017-02-22: No limits at all<br />
    ...
    /* Basic constants */
    private final String                   mainpage                                     = "http://filez.tv";
    private final String                   domains                                      = "(filez\\.tv|filecloud\\.tv)";
    ...
    private static final boolean           enable_embed                                 = true;
