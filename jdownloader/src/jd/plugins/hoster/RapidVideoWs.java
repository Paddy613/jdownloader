...
@HostPlugin(revision = "$Revision: 34706 $", interfaceVersion = 2, names = { "rapidvideo.ws", "xvidstage.com" }, urls = { "https?://(www\\.)?rapidvideo\\.ws/(embed\\-)?[a-z0-9]{12}", "https?://(www\\.)?xvidstage\\.com/(embed\\-)?[a-z0-9]{12}" }) 
