...
@HostPlugin(revision = "$Revision: 36444 $", interfaceVersion = 2, names = { "wetransfer.com" }, urls = { "https?://(?:www\\.)?((wtrns\\.fr|we\\.tl)/[\\w\\-]+|wetransfer\\.com/downloads/([a-f0-9]{46}/)?[a-f0-9]{46}(/[a-z0-9]+)?)" })
