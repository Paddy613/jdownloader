...
@HostPlugin(revision = "$Revision: 34706 $", interfaceVersion = 2, names = { "ulshare.se", "musickapoz.se" }, urls = { "https?://(www\\.)?(musickapoz|ulshare)\\.se/(embed\\-)?[a-z0-9]{12}", "REGEX_NOT_POSSIBLE_RANDOM-asdfasdfsadfsdgfd32424" }) 
