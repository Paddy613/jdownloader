...
@HostPlugin(revision = "$Revision: 35514 $", interfaceVersion = 2, names = { "exashare.com" }, urls = { "https?://(?:www\\.)?(?:exashare\\.com|dowed\\.info|bojem3a\\.info|ajihezo\\.info|ohbuegh3ev\\.com)/((vid)?embed\\-)?[a-z0-9]{12}" })
