...
@HostPlugin(revision = "$Revision: 36213 $", interfaceVersion = 3, names = { "takefile.link" }, urls = { "https?://(?:www\\.)?takefile\\.link/(?:embed\\-)?[a-z0-9]{12}" })
public class TakefileLink extends PluginForHost {
