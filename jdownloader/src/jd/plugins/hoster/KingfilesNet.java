...
@HostPlugin(revision = "$Revision: 35894 $", interfaceVersion = 3, names = { "kingfiles.net" }, urls = { "https?://(?:www\\.)?kingfiles\\.net/(?:embed\\-)?[a-z0-9]{12}" })
public class KingfilesNet extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                        = "http://kingfiles.net";
    private static final String            NICE_HOST                          = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                            = "(kingfiles\\.net)";
