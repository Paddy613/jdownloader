...
@HostPlugin(revision = "$Revision: 36261 $", interfaceVersion = 2, names = { "makinamania.net" }, urls = { "http://(www\\.)?makinamania\\.(com|net)/((download/|descargar\\-).+|index\\.php\\?action=dlattach;topic=\\d+(?:\\.0)?;attach=\\d+)" })
