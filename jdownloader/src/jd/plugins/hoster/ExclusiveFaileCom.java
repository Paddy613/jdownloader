...
@HostPlugin(revision = "$Revision: 35546 $", interfaceVersion = 3, names = { "exclusiveloader.com", "exclusivefaile.com" }, urls = { "https?://(www\\.)?(exclusivefaile\\.com|exclusiveloader\\.com)/((vid)?embed-)?[a-z0-9]{12}", "NOTUSED_4812jdmSDusd4aSAJD415uauadfjadafasadx" })
