...
@DecrypterPlugin(revision = "$Revision: 35841 $", interfaceVersion = 2, names = { "pornxs.com" }, urls = { "http://(www\\.)?(pornxs\\.com/(video\\.php\\?id=|[a-z0-9\\-]+/)|embed\\.pornxs\\.com/embed\\.php\\?id=)\\d+([a-z0-9\\-]+\\.html)?" })
