...
@DecrypterPlugin(revision = "$Revision: 36420 $", interfaceVersion = 2, names = { "links-secure.com" }, urls = { "https?://(?:www\\.)?(?:links-secure\\.com|h-link\\.us|foxmoviez\\.com|zmelody\\.com|filmey\\.co|wwenews\\.us)/[0-9]+" })
