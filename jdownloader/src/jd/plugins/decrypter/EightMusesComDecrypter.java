...
@DecrypterPlugin(revision = "$Revision: 36137 $", interfaceVersion = 3, names = { "8muses.com" }, urls = { "https?://(?:www\\.)?8muses\\.com/comix/(?:index/category/[a-z0-9\\-_]+|album(?:/[a-z0-9\\-_]+){1,3})" })
