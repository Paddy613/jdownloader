...
@DecrypterPlugin(revision = "$Revision: 35863 $", interfaceVersion = 3, names = { "bonbonme.com" }, urls = { "http://((av|dl)\\.)?bonbonme\\.com/(?!makemoney|data/|forum/)[A-Za-z0-9\\-_]+/(?!list_)[A-Za-z0-9\\-_]+\\.html" })
