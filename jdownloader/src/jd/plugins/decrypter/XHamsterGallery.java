...
@DecrypterPlugin(revision = "$Revision: 35156 $", interfaceVersion = 3, names = { "xhamster.com" }, urls = { "https?://(www\\.)?((de|es|ru|fr|it|jp|pt|nl|pl)\\.)?xhamster\\.com/photos/(gallery/[0-9]+/.*?\\.html|view/[0-9\\-]+.*?\\.html)" })
