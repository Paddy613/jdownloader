...
@DecrypterPlugin(revision = "$Revision: 34675 $", interfaceVersion = 3, names = { "mega.enc" }, urls = { "mega://f?enc\\d*\\?[a-zA-Z0-9-_]+" }) public class MegaEncDecrypter extends PluginForDecrypt {
