...
@DecrypterPlugin(revision = "$Revision: 36193 $", interfaceVersion = 3, names = { "shrink-service.it" }, urls = { "https?://(?:www\\.)?shrink\\-service\\.it/s/[A-Za-z0-9]+|https?://get\\.shrink\\-service\\.it/[A-Za-z0-9]+" })
