...
@DecrypterPlugin(revision = "$Revision: 36191 $", interfaceVersion = 3, names = { "tumblr.com" }, urls = { "https?://(?!\\d+\\.media\\.tumblr\\.com/.+)[\\w\\.\\-]+?tumblr\\.com(?:/(audio|video)_file/\\d+/tumblr_[A-Za-z0-9]+|/image/\\d+|/post/\\d+|/?$|/archive.+|/(?:dashboard/)?blog/[^/]+)(?:\\?password=.+)?" })
