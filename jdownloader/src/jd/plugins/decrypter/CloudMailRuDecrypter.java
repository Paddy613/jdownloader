...
@DecrypterPlugin(revision = "$Revision: 34675 $", interfaceVersion = 3, names = { "cloud.mail.ru" }, urls = { "https?://(www\\.)?cloud\\.mail\\.ru((?:/|%2F)public(?:/|%2F)[a-z0-9]+(?:/|%2F)[^<>\"]+|(?:/|%2F)(?:files(?:/|%2F))?[A-Z0-9]{32})" }) 
public class CloudMailRuDecrypter extends PluginForDecrypt {
    ...
    public ArrayList<DownloadLink> decryptIt(CryptedLink param, ProgressController progress) throws Exception {
        ...
        for (final String singleinfo : links) {
            if ("folder".equals(PluginJSonUtils.getJsonValue(singleinfo, "kind"))) {
